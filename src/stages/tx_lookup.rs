    ...
    RwTx: MutableTransaction<'db>,
{
        ...
        'db: 'tx,
    {
        ...
        let walker_block_body = bodies_cursor.walk(Some(start_block_number.to_vec()), |_| true);
            ...
            walker_block_body.try_next().await?
        {
            ...
            let walker_block_txs = block_txs_cursor.walk(Some(tx_base_id_as_bytes), |_| true);
