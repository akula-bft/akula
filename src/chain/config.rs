...
pub static MAINNET_CONFIG: Lazy<ChainConfig> = Lazy::new(|| ChainConfig {
    ...
    dao_fork: Some(DaoConfig {
        ...
        beneficiary: H160(hex!("bf4ed7b27f1d666546e30d74d50d173d20bca754")),
        drain: hashset![
    ...
    tangerine_block: Some(2_463_000.into()),
    spurious_block: Some(2_675_000.into()),
    byzantium_block: Some(4_370_000.into()),
    constantinople_block: Some(7_280_000.into()),
    petersburg_block: Some(7_280_000.into()),
    istanbul_block: Some(9_069_000.into()),
    muir_glacier_block: Some(9_200_000.into()),
    berlin_block: Some(12_244_000.into()),
    london_block: Some(12_965_000.into()),
});
...
pub static ROPSTEN_CONFIG: Lazy<ChainConfig> = Lazy::new(|| ChainConfig {
    ...
    spurious_block: Some(10.into()),
    byzantium_block: Some(1_700_000.into()),
    constantinople_block: Some(4_230_000.into()),
    petersburg_block: Some(4_939_394.into()),
    istanbul_block: Some(6_485_846.into()),
    muir_glacier_block: Some(7_117_117.into()),
    berlin_block: Some(9_812_189.into()),
    london_block: Some(10_499_401.into()),
});
